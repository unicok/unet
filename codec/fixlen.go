...
func FixLen(base unet.Protocol, n int, byteOrder binary.ByteOrder, maxRecv, maxSend int) *FixLenProtocol {
...
func (p *FixLenProtocol) NewCodec(rw io.ReadWriter) (cc unet.Codec, err error) {
	codec := &fixlenCodec{
		rw:             rw,
		FixLenProtocol: p,
	}
